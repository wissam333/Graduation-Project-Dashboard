      ...
      <ClientOnly>
        ...
        >
          ...
          <LMarker :lat-lng="restaurantLocation">
            <LIcon :icon-url="restaurantIcon" :icon-size="[32, 32]" />
            <LPopup>
          ...
          >
            <LIcon :icon-url="orderIcon" :icon-size="[28, 28]" />
            <LPopup>
              <div class="popup-content">
...
const restaurantIcon = "/icons/restaurant-marker.png";
const orderIcon = "/icons/order-marker.png";
