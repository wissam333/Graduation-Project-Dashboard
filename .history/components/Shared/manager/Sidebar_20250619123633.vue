<template>
  ...
  <div class="sidebar box" :class="useSidebar().value ? '' : 'open'">
    <ul class="main-links">
      ...
      <nuxt-link to="/manager/categories">
      ...
      <nuxt-link to="/manager/users/managers">
        <li :class="activeLink == 'Managers' ? 'active' : ''">
          <Icon class="icon" name="fa6-solid:users" />
          <span>{{ $i18n.locale === "ar" ? "المدراء" : "Managers" }}</span>
        </li>
      </nuxt-link>

      <nuxt-link to="/manager/users/drivers">
        <li :class="activeLink == 'Drivers' ? 'active' : ''">
          <Icon class="icon" name="fa6-solid:users" />
          <span>{{ $i18n.locale === "ar" ? "السائقين" : "Drivers" }}</span>
        </li>
      </nuxt-link>

      <nuxt-link to="/manager/meals">
        <li :class="activeLink == 'Meals' ? 'active' : ''">
          <Icon class="icon" name="mdi:chicken-leg" />
          <span>
      ...
      <nuxt-link to="/manager/orders">
        <li :class="activeLink == 'Orders' ? 'active' : ''">
          <Icon class="icon" name="mdi:cart" />
          <span>
            {{ $i18n.locale === "ar" ? "قائمة الطلبات" : "Orders List" }}</span
          >
        </li>
      </nuxt-link>
