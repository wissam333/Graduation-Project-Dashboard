        ...
        <div class="filter-dropdowns">
          ...
          <div class="dropdown">
            ...
            >
              ...
              <template v-else>
                {{ selectedRestaurant ? selectedRestaurant.name : ($i18n.locale === "ar" ? "تصفية بالمطعم" : "Filter by Restaurant") }}
            ...
            <div v-if="showRestaurantDropdown" class="dropdown-menu">
              <input
                ...
                :placeholder="$i18n.locale === 'ar' ? 'ابحث عن مطعم' : 'Search restaurant'"
              ...
              <div class="dropdown-items">
                ...
                <div v-if="filteredRestaurants.length === 0" class="dropdown-item empty">
          ...
          <div class="dropdown">
            ...
            >
              ...
              <template v-else>
                {{ selectedClient ? `${selectedClient.name} (${selectedClient.email})` : ($i18n.locale === "ar" ? "تصفية بالعميل" : "Filter by Client") }}
                <Icon name="mdi:chevron-down" class="icon" />
              </template>
            </button>
            <div v-if="showClientDropdown" class="dropdown-menu">
              <input
                ...
                :placeholder="$i18n.locale === 'ar' ? 'ابحث عن عميل' : 'Search client'"
                class="dropdown-search"
                @input="filterClients"
              />
              <div class="dropdown-items">
                ...
                <div v-if="filteredClients.length === 0" class="dropdown-item empty">
                  {{ $i18n.locale === "ar" ? "لا توجد نتائج" : "No results found" }}
                </div>
              </div>
            </div>
