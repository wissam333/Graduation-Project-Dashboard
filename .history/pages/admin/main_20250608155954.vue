          ...
          <div class="sales-summary-content">
            <div class="sales-metric">
              ...
              <div class="metric-value">
                {{ formatDate(dashboardData.charts?.salesTrend[0]?.date) }}
              </div>
            </div>
            <div class="sales-metric">
              <div class="metric-label">
              ...
              <div class="metric-value">
                {{ formatCurrency(dashboardData.charts?.salesTrend[0]?.total) }}
              </div>
            </div>
            <div class="sales-metric">
              <div class="metric-label">
                <Icon name="ph:shopping-cart" size="16" />
                <span>{{ $t("Orders Count") }}</span>
              </div>
              <div class="metric-value">
                {{ dashboardData.charts?.salesTrend[0]?.count }}
              </div>
            </div>
          </div>
        </template>
