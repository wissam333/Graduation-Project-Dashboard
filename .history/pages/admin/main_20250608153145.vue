...
const revenueTrend = computed(() => dashboardData.value.revenueTrend || 0);
const ordersTrend = computed(() => dashboardData.value.ordersTrend || 0);
const aovTrend = computed(() => dashboardData.value.aovTrend || 0);
</script>
