...
const periodOptions = ref([
  { nameEn: "Today", nameAr: "اليوم", value: "today" },
  { nameEn: "This Week", nameAr: "هذا الاسبوع", value: "week" },
  { nameEn: "This Month", nameAr: "هذا الشهر", value: "month" },
  { nameEn: "This Year", nameAr: "هذه السنة", value: "year" },
]);
...
const fetchDashboardData = async (period) => {
  try {
    ...
    if (statsData.value) {
      ...
      setSalesTrendChartData(statsData.value.charts.salesTrend); // Add this line
    }
  } catch (error) {
