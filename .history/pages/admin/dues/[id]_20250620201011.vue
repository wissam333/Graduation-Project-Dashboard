      ...
      <div class="order-summary">
        ...
        <div class="summary-card">
          ...
          <div class="summary-row">
            ...
            >
            <span class="value">{{ order?.assignedDriver }}</span>
          </div>
          <div class="summary-row">
            <span class="label"
              >{{
...
const printOrder = async () => {
  try {
    const { data: invoice, error } = await useFetch(
      `${api.OrdersApi}/${route.params.id}/invoice`,
      {
        baseURL: apiBase,
        headers: {
          "accept-language": locale.value,
        },
        responseType: "blob", // This is crucial for PDF responses
      }
    );
    ...
    const blob = new Blob([invoice.value], { type: "application/pdf" });
