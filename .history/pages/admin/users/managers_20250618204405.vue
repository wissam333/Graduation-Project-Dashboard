...
const getManagers = async () => {
  loading.value = true;
  try {
    const { data: managersData } = await useFetch(`${api.ManagersApi}`, {
      baseURL: apiBase,
      headers: {
...
const deleteManager = async () => {
  try {
    await useFetch(`${api.ManagersApi}/${deletedManager.value._id}`, {
      baseURL: apiBase,
      method: "DELETE",
    });
...
const updateManager = async () => {
  try {
    ...
    await useFetch(`${api.ManagersApi}/${currentManagerId.value}`, {
      baseURL: apiBase,
      method: "PUT",
      body: body,
      headers: {
...
const toggleManagerStatus = async (manager) => {
  try {
    await useFetch(`${api.ManagersApi}/toggle-status/${manager._id}`, {
      baseURL: apiBase,
      method: "PUT",
      headers: {
        "accept-language": locale.value,
