        ...
        <table>
          ...
          <tbody>
            <tr class="table-row" v-for="user in filteredArray" :key="user._id">
              ...
              <td class="email-cell">{{ user.location }}</td>
              <td class="date-cell">
                <span class="badge">
...
const filteredArray = computed(() => {
  return restaurantsData.value?.filter((item) =>
  ...
  const er = async () => {
    ...
    try {
      ...
      if (data.value.latitude && data.value.longitude) {
        clientGeoLocation.value.latitude = data.value.latitude;
        clientGeoLocation.value.longitude = data.value.longitude;
        marker.value = {
