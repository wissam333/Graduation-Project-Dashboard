...
const fetchAddresses = async () => {
  for (const user of filteredArray.value) {
...
// Fetch addresses when filteredArray changes
watch(filteredArray.value, fetchAddresses, { immediate: true });
